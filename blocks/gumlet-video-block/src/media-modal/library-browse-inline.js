/**
 * Inline Gumlet library browse for the wp.media tab (no nested modal).
 */
 ...
 */
export default function LibraryBrowseInline( { onSelect } ) {
	...
	return (
		<div className="gumlet-media-modal-library-browse">
			<h3
				style={ {
					margin: '0 0 12px',
					fontSize: '13px',
			...
			>
				...
				<div style={ { minWidth: 0 } }>
					<TextControl
						...
						value={ search }
						onChange={ setSearch }
						placeholder={ __( 'Filter assets…', 'gumlet-video' ) }
					/>
				</div>
			</div>
